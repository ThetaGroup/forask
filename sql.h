...
#define CREATE_TASK_TABLE_SQL "create table task(id integer primary key autoincrement,title varchar(128),content varchar(1024),state varchar(2));"
...
#define INSERT_TASK_SQL "insert into task (title,content,state) values ('%s','%s','%s');"
...
#define QUERY_TASK_BY_STATE_SQL "select id,title,content from task where state='%s';"
